  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-slate-50 hover:bg-primary hover:text-slate-50 focus:bg-primary focus:text-slate-50 dark:bg-primary dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
          "bg-primary/30 text-slate-900 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-primary/40 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50",
