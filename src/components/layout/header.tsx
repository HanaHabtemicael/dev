        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="flex items-center gap-2">
             <Image  src="/assets/logo/picture.png" alt= "imag" width={32} height={32}/>
             
              <div className="text-sm text-right">
                <div className="text-black">GAS</div>
                <div className="text-muted-foreground text-xs text-slate-800">GAS@mail.com</div>
              </div>
